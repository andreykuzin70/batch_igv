...
def main():
    ...
    parser.add_argument('--range', type = int, help = 'Sets how many bases can be seen on either side of position', default= 50)
    ...
    print_locations(df, outputFile, args)
    outputFile.close()
...
def print_locations(df, outputFile, args):
    """
    ...
    for i in range(0, len(df.index)):
        outputFile.write("goto chr"+ str(df.loc[i,'CHROM']) + ":" + str(df.loc[i,'POS']-args.range) + "-" + str(df.loc[i,'POS']+args.range) + "\n" )
...
#Parameter examples: python AutomatedBatchScript.py C:\Users\ank22\igv_session.xml 400 NewBatchFile C:\Users\ank22\Documents\SnapShots C:\Users\ank22\Documents\hg002_deepvar_manual_currate.csv C:\IGV_2.5.0\igv.bat --runScript

#Parameter examples: python batch_igv.py Y:\data\igv_sessions\igv_test_session_ak_hg002.xml 400 FilesUsedBatch Y:\data\SnapShots C:\Users\ank22\Documents\hg002_deepvar_manual_currate.csv C:\IGV_2.5.0\igv.bat --runScript


#Parameters example: python batch_igv.py Y:\data\igv_sessions\igv_test_session_ak_hg002.xml 400 FilesUsedBatch C:\Users\ank22\Documents\SnapShots\test C:\Users\ank22\Documents\PositionSet.csv C:\IGV_2.5.0\igv.bat --runScript
